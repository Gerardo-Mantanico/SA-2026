    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            if (jwt != null && jwtUtils.validateJwtToken(jwt)) {
                ...
                // 1. Check if token is in blocklist (e.g. manually logged out)
                ...
                // 2. Fetch user to verify state (block status and password version).
                // Note: This database check is what makes JWT "stateful" for real-time revocation.
