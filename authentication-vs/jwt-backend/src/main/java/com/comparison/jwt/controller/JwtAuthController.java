...
import com.comparison.jwt.dto.ChangePasswordRequest;
import com.comparison.jwt.dto.LoginRequest;
import com.comparison.jwt.dto.LoginResponse;
...
import com.comparison.jwt.security.JwtUtils;
import com.comparison.jwt.security.RefreshTokenService;
...
public class JwtAuthController {
    ...
    public ResponseEntity<?> refresh(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            return refreshTokenService.findByToken(token)
                    ...
                    .orElseGet(() -> ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(Map.of("error", "Refresh token not found. Please log in again.")));
        } catch (Exception e) {
    ...
    public ResponseEntity<?> changePassword(@Valid @RequestBody ChangePasswordRequest changeRequest, Principal principal, HttpServletRequest request, HttpServletResponse response) {
        if (principal == null) {
